    ...
    <div>
      <div className="w-full h-[230px] mb-4 flex justify-between relative top-20 gap-4">
            <Skeleton className="w-[130px] h-[150px] bg-[#ffffff83] rounded-none rounded-t-3xl">
              <Skeleton className=" absolute z-[1] -top-10 left-6 w-20 h-20 rounded-full bg-[#ffffff83]"></Skeleton>
            </Skeleton>
            ...
            <Skeleton className="w-[130px] h-[150px] bg-[#ffffff83] rounded-none rounded-t-3xl">
              <Skeleton className=" absolute z-[1] -top-10 right-6 w-20 h-20 rounded-full bg-[#ffffff83]"></Skeleton>
            </Skeleton>
      </div>
