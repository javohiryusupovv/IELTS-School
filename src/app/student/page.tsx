    ...
    <div className="pt-5 min-h-screen pb-20">
      <article className="w-11/12 rounded-md m-auto mb-10">
        <div className=" relative top-0 left-0 rounded-[20px] overflow-hidden">
          <Image className="absolute left-10 top-5 w-[150px]" src={IQLogo} alt="ChipCard"/>
          <article className=" absolute top-16 w-full flex justify-between items-center px-10">
            <Image src={CreditCardChip} alt="ChipCard"/>
            <Image src={CreditCardWife} alt="CreditCard Wife" />
          </article>
          <Image src={CreditCard} alt="CardCredit" />
          <div className="flex justify-between w-full absolute bottom-0 h-[70px] px-10 backdrop-blur-lg bg-white/30">
            <article className="mt-3"> 
              <p className="text-[13px] text-white">Karta egasi</p>
              <span className="text-[17px] font-medium text-white">{student?.surname} {student?.name}</span>
            </article>
            <div className="mt-3">
