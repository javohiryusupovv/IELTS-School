    ...
    <div>
      <ul className="flex flex-col">
        ...
        <li className={`group py-5 cursor-pointer pl-0`}>
          <a href="" className={`flex  transition-all duration-300 flex-col gap-0 items-center`}>
            ...
            <p className={`font-light group-hover:text-orange-600 transition-all duration-200 text-[16px]`}>Beginner</p>
          </a>
        </li>
        <p className="w-full h-[1px] bg-[#0000003f]"></p>
        <li className={`group py-5 cursor-pointer pl-0`}>
