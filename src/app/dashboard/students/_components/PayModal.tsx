...
import { NextPaymentDate } from "../../_components/Qarzdor/QarzdorStudents";
        ...
        <AlertDialogContent className="max-sm:w-[400px] max-sm:rounded-md max-sidebar:w-[320px]">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-500 text-[14px]">
              Iltimos, quyidagi ma’lumotlarni to‘ldiring va to‘lov turini
              tanlang.
            </AlertDialogDescription>
          </AlertDialogHeader>
          ...
          <div className="space-y-3 my-4 text-[14px]">
            ...
            <div className="flex justify-between items-center">
              ...
              <Select
                value={paymentType}
                onValueChange={(val: "Naqd" | "Karta") => setPaymentType(val)}
              >
