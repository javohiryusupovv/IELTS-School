      ...
      <div className="w-full border bg-white rounded-lg pb-20">
        ...
        <ul className="mb-16">
          <li>
            <Link
              href={"/dashboard"}
              className={`group flex items-center gap-2 py-5 px-2 border-b hover:bg-orange-300 hover:text-white cursor-pointer transition-all duration-200 ${pathnames === "/dashboard" ? "bg-orange-400 text-white" : ""
                }`}
            >
          ...
          <li>
            <Link
              ...
              className={`group flex items-center gap-2 py-5 px-2 border-b hover:bg-orange-300 hover:text-white cursor-pointer transition-all duration-200 ${pathnames === "/dashboard/teacher"
          ...
          <li>
            <Link
              ...
              className={`group flex items-center gap-2 py-5 px-2 border-b hover:bg-orange-300 hover:text-white cursor-pointer transition-all duration-200 ${pathnames === "/dashboard/courses"
                  ? "bg-orange-400 text-white"
                  : ""
                }`}
            >
          ...
          <li>
            <Link
              ...
              className={`group flex items-center gap-2 py-5 px-2 border-b hover:bg-orange-300 hover:text-white cursor-pointer transition-all duration-200 ${pathnames === "/dashboard/students"
                  ? "bg-orange-400 text-white"
                  : ""
                }`}
            >
          ...
          <li>
            <Link
              ...
              className={`group flex items-center gap-2 py-5 px-2 border-b hover:bg-orange-300 hover:text-white cursor-pointer transition-all duration-200 ${pathnames === "/dashboard/orders"
                  ? "bg-orange-400 text-white"
                  : ""
                }`}
            >
